...
/**
 * Only for Apple Mail and Gmail: responsive padding, plus Apple Mail's dark palette
...
const STYLES = `
  ...
  @media screen and (max-width:620px) {
    ...
    .question-middle { height:300px !important; }
  }
 ...
 */
async function renderEmail(edition: Edition, coverSrc: string) {
    ...
    const body = renderToStaticMarkup(
        ...
        >
            <tbody>
                <Masthead edition={edition} coverSrc={coverSrc} />
                {edition.content}
                <QuestionCard question={edition.question} />
